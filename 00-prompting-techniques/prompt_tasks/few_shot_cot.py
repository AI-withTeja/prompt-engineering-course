...
prompt = f'''
    ...
    You are Teacher of Mathematics in School who has 10 years of experience.
    ...
    Solve step by step internally, but show only the final explanation clearly.
    ...
    Explanation:
        Step-1: Speed =	60 x (5/18) m/sec =	50/3 m/sec.

        Step-2: Length of the train = (Speed x Time).

        Step-3: Therefore, Length of the train =	(50/3)	x 9 m = 150 metres.
